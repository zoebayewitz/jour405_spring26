...
ANSWER HERE: I predict that at the beginning of the month, especially around holidays (Halloween, NYE) there are more overdoses. A line highlighting unusual days would show the random high spikes throughout the year, as well as unusual low days.
...
ANSWER HERE: These answers are primarily the same. The red dot does indicate that overdoses don't increase on Halloween, which I misread. It also demonstrates higher unusual scores in the early spring, and lower in the fall/winter; I would not have expected this.
...
ANSWER HERE: Saturday's had the highest average amount of overdose calls to 911 in Baltimore in 2022.
...
ANSWER HERE: I would definitely do more investigation on what caused spikes in overdoses. These are likely due to bad batches of fentanyl, so I would do my best to find eye-witness reports from drug-users about what caused these overdoses. I would tell an editor that these are overdoses are seemingly random, but probably are due to the fentanyl being distributed.

...
ANSWER HERE: One pattern is a big drop in accidents in 2020; I would predict this is due to COVID, which could be a story. Another pattern is a rise in crime in 2021, which could relate to COVID as well. I would want to investigate from when COVID happened to 2022 and see why there was a spike in accidents.
...
ANSWER HERE: The weekend has higher average accidents, and weekdays have lower average incidents. This is probably because people go out and drink on the weekends, so there's much more reckless and drunk driving.
...
ANSWER HERE: 11/29/2021 was an unusual day, with only 1 accident. On that day, Prince George's county passed a Countywide Map Amendment that including new zoning. Because of possible confusion from police officers, as well as data potentially being messed up from the amendment, there was probably less accidents recorded.
...
ANSWER HERE: From my observation, days with high extreme z-scores also had high day-of-week z-scores. Both show that Friday and Saturday have unusually high scores. While the first list shows all days with extreme z-scores, the second list shows days that are unusual relative to other dates on the same day. From these approaches, you can identify which days have unusually high scores, and what specific years might have correlated with high scores.
...
ANSWER HERE: May and October have the highest average accidents, and January and March have the lowest average accidents. A hypothesis could be that during May and October, because of more mild weather, people are more likely to go outdoors, travel, etc. This could lead to increased traffic incidents. January and March are months with cold weather and no major holidays, so people are less likely to travel. 
...
ANSWER HERE: All of the extreme outliers took place on a Friday and Saturday. This makes sense, since more accidents are likely to happen over the weekends when people are going out and driving.
...
Traffic accidents in Prince George's County spike over the weekends and during mild-weather months, indicating that behavioral and seasonal factors contribute greatly to accident spikes.

In Prince George's County, Fridays and Saturdays, as well as in May and October, traffic accidents happen on average more than on any other days or in other months. Nightlife, weather conditions, and daylight changes may all contribute to higher accidents.
